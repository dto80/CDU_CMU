...
import edu.cmucdu.ecommerce.domain.product.ProductIntegrationTest;
...
privileged aspect ProductIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    ProductDao ProductIntegrationTest.productDao;
    ...
    public void ProductIntegrationTest.testFindEntries() {
        ...
        List<Product> result = productDao.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    ...
    public void ProductIntegrationTest.testSaveUpdate() {
        ...
        boolean modified =  dod.modifyProduct(obj);
        Integer currentVersion = obj.getVersion();
        Product merged = productDao.save(obj);
        productDao.flush();
    ...
    public void ProductIntegrationTest.testDelete() {
        ...
        productDao.flush();
        Assert.assertNull("Failed to remove 'Product' with identifier '" + id + "'", productDao.findOne(id));
    }
