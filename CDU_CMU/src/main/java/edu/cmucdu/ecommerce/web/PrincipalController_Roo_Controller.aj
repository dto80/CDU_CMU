...
import edu.cmucdu.ecommerce.web.PrincipalController;
...
privileged aspect PrincipalController_Roo_Controller {
    ...
    @Autowired
    UserDetailDao PrincipalController.userDetailDao;
    ...
    public String PrincipalController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void PrincipalController.populateEditForm(Model uiModel, Principal principal) {
        ...
        uiModel.addAttribute("userdetails", userDetailDao.findAll());
    }
